...
abstract class Barcode
{
     ...
     * {@link CObject\AbstractObject} class
     ...
     * @param mixed $barcodeConfig  OPTIONAL; an array or Traversable object with barcode parameters.
     * @return CObject\ObjectInterface
     *@throws Exception\InvalidArgumentException
     */
    public static function makeBarcode($barcode, $barcodeConfig = [])
    {
        if ($barcode instanceof CObject\ObjectInterface) {
            return $barcode;
        }
     ...
     *
     * @param string | CObject\ObjectInterface | array | Traversable $barcode
